...
import com.com.pts.entitys.TimeReport;import java.util.regex.Pattern;
import org.springframework.stereotype.Service;
import com.com.pts.pojo.TimeReportPojo;


    @Service
    public class TimeReportValidation {

        public TimeReportPojo valida(TimeReportPojo timereport) {
        TimeReportPojo pojo = null;
        try {
             if (timereport != null) {
              if (
        timereport.getTimededicate() != null &&
        timereport.getTimededicatetotal() != null &&
        timereport.getIdreport() != null &&
        timereport.getUsercode() != null        ) {
        pojo = timereport;
         }
        }
            return pojo;
