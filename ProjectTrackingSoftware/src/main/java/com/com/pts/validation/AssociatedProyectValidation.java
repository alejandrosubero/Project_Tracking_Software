...
@Service
public class AssociatedProyectValidation {

    public AssociatedProyectPojo valida(AssociatedProyectPojo associatedproyect) {
        AssociatedProyectPojo pojo = null;
        try {
            if (associatedproyect != null) {
                if (associatedproyect.getIdproyect() != null &&
                    associatedproyect.getIdreport() != null ) {
                    pojo = associatedproyect;
                }
            }
            return pojo;
        } catch (Exception e) {
