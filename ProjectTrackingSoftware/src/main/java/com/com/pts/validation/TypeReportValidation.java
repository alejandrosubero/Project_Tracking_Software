...
import com.com.pts.entitys.TypeReport;import java.util.regex.Pattern;
import org.springframework.stereotype.Service;
import com.com.pts.pojo.TypeReportPojo;


    @Service
    public class TypeReportValidation {

        public TypeReportPojo valida(TypeReportPojo typereport) {
        TypeReportPojo pojo = null;
        try {
             if (typereport != null) {
              if (
        typereport.getType() != null &&
        typereport.getDescripton() != null        ) {
        pojo = typereport;
         }
        }
            return pojo;
