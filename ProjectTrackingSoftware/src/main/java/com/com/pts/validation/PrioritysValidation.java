...
import com.com.pts.entitys.Prioritys;import java.util.regex.Pattern;
import org.springframework.stereotype.Service;
import com.com.pts.pojo.PrioritysPojo;


    @Service
    public class PrioritysValidation {

        public PrioritysPojo valida(PrioritysPojo prioritys) {
        PrioritysPojo pojo = null;
        try {
             if (prioritys != null) {
              if (
        prioritys.getValue() != null &&
        prioritys.getDescription() != null        ) {
        pojo = prioritys;
         }
        }
            return pojo;
