...
public interface ProyectsRepository extends CrudRepository<Proyects, Long> {

    public Optional<Proyects> findByTitleProyect(String titleProyect);

    public List<Proyects> findByTitleProyectContaining(String titleProyect);

    public Optional<Proyects> findByDescription(String description);
