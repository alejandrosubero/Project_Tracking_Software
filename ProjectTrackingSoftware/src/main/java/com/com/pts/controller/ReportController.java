...
package com.com.pts.controller;
import com.com.pts.entitys.Report;
import com.com.pts.validation.ReportValidation;
import com.com.pts.mapper.ReportMapper;
import com.com.pts.service.ReportService;
import com.com.pts.mapper.MapperEntityRespone;
import com.com.pts.pojo.EntityRespone;
...
import com.com.pts.validation.TypeReportValidation;
import com.com.pts.mapper.TypeReportMapper;
import com.com.pts.entitys.AssociatedProyect;
import com.com.pts.validation.AssociatedProyectValidation;
import com.com.pts.mapper.AssociatedProyectMapper;
import com.com.pts.entitys.TimeReport;
import com.com.pts.validation.TimeReportValidation;
import com.com.pts.mapper.TimeReportMapper;
import com.com.pts.entitys.TimeAssigned;
import com.com.pts.validation.TimeAssignedValidation;
import com.com.pts.mapper.TimeAssignedMapper;
...
public class ReportController {
   ...
   MapperEntityRespone mapperEntityRespone;
    ...
    TimeAssignedMapper timeassignedMapper;
        ...
        private ResponseEntity<EntityRespone> findByCommitmentDateContain(@PathVariable("commitmentdate") Date  commitmentdate) {
              Date busca = (Date) reportValidationService.validation(commitmentdate);
        ...
        private List<Report> findByAssociatedProyect(@RequestBody AssociatedProyectPojo  associatedproyect){ 
            return reportService.findByAssociatedProyectContaining(associatedproyectMapper.pojoToEntity(associatedproyectValidationService.valida(associatedproyect))); }


        @PostMapping("/Get_times _contain/")
        private List<Report> findByTimeReport(@RequestBody TimeReportPojo  timereport){ 
            return reportService.findByTimeReportContaining(timereportMapper.pojoToEntity(timereportValidationService.valida(timereport))); }


        @PostMapping("/Get_assigmeds _contain/")
        private List<Report> findByTimeAssigned(@RequestBody TimeAssignedPojo  timeassigned){ 
            return reportService.findByTimeAssignedContaining(timeassignedMapper.pojoToEntity(timeassignedValidationService.valida(timeassigned))); }
        ...
        private ResponseEntity<EntityRespone> findRelacionTypeReport(@RequestBody TypeReportPojo typereport){ 
           EntityRespone entityRespone = mapperEntityRespone.setEntityT(reportService.findByRelacionTypeReport(typereportMapper.pojoToEntity(typereportValidationService.valida(typereport))));
            return new ResponseEntity<EntityRespone>(entityRespone, HttpStatus.OK);
}
}
 /*
