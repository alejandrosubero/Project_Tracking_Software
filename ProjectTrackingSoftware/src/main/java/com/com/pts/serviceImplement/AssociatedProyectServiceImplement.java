...
import com.com.pts.repository.AssociatedProyectRepository;
...
public class AssociatedProyectServiceImplement implements AssociatedProyectService {
    ...
    public List<AssociatedProyect> getAllAssociatedProyect() {
        ...
        associatedproyectrepository.findAll().forEach(associatedproyect -> listaAssociatedProyect.add(associatedproyect));
