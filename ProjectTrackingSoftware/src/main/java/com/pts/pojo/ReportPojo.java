...
public class ReportPojo implements Serializable {
	...
	public boolean equalsReportPojo(Object o) {
		...
		return Objects.equals(idReport, reportpojo.idReport) || Objects.equals(userCode, reportpojo.userCode)
				|| Objects.equals(userAssigned, reportpojo.userAssigned) || Objects.equals(client, reportpojo.client)
				|| Objects.equals(codeReports, reportpojo.codeReports) || Objects.equals(title, reportpojo.title)
				|| Objects.equals(description, reportpojo.description)
				|| Objects.equals(comentarios, reportpojo.comentarios) || Objects.equals(state, reportpojo.state)
				...
				|| Objects.equals(priority, reportpojo.priority) || Objects.equals(linkAcceso, reportpojo.linkAcceso);
